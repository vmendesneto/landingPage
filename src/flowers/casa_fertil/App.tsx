...
export default function AppCasaFertil(): JSX.Element {
  return (
    <LandingPageSkeleton
      ...
      argumentos1={
        <Arg1
          backgroundUrl={theme.imagens.fundoSecundaria}
          imageUrl={theme.imagens.imagemSecundaria}
      ...
      argumentos2={
        <Arg1
          backgroundUrl={theme.imagens.imagemPrincipal}
          imageUrl={theme.imagens.imagemTerceira}
      ...
      dorSolucao={
        <Arg1
          backgroundUrl={theme.imagens.fundoSecundaria}
          imageUrl={theme.imagens.imagemQuarta}
      ...
      argumentos3={
        <Arg1
          backgroundUrl={theme.imagens.fundoSecundaria}
          imageUrl={theme.imagens.imagemQuinta}
